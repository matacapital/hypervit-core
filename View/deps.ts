...
export type {
  ErrorPageProps as ErrorPagePropsType,
  UnknownPageProps as UnknownPagePropsType,
...
export type { AppConfigType } from "../Config/types.ts";
export { Container, Keys } from "../Container/Container.ts";
