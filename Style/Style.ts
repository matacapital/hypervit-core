...
import { ColorType, IStyle, ModifierType } from "./types.ts";
...
export class Style implements IStyle {
   ...
   */
  public bgc(color: ColorType | null): this {
    this.bgColor = color;
  ...
  /**
   * @inheritDoc IStyle.lightBg
   */
  public lightBg(isLight = true): this {
    this.bgColorLight = isLight;
   ...
   */
  public color(color: ColorType | null): this {
  ...
  /**
   * @inheritDoc IStyle.light
   */
  public light(isLight = true): this {
    this.fontColorLight = isLight;
